...
public class HistoryFragment extends BaseFragments implements Paginate.Callbacks {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        //database object singleton initialization
    ...
    private void getDataFromDB() {
        lstPatientData = dbHandler.getAllDataFromDetails();
        if (lstPatientData.size() == 0) {
            rvPatients.setEmptydata(getString(R.string.no_history_found), "", R.drawable.icn_no_data);
        }
        loading = false;
